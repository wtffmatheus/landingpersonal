...
(() => {
  ...
  safeInit(() => {
    ...
    form.addEventListener('submit', (event) => {
      ...
      const message = `Olá! Meu nome é ${name}. Conheci o trabalho da Rosangela na RV Fisiologia pelo site. Meu principal objetivo é ${goal}.${challengeText} Gostaria de entender qual formato de acompanhamento faz sentido para mim.`;
